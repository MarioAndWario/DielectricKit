...
!! Module:
!!
!! (1) mtxel()             By Meng Wu (2020)
!!
!!     Compute matrix elements of density operator 
!!
!!     pol%k_plus_q = F : calculate mdat = < c, k   | e^{i(q+G).r} | v, k-q >
!!                  = T : calculate mdat = < v, k+q | e^{i(q+G).r} | c, k   >
!===========================================================================
